...
function (_React$Component) {
  ...
  function AppLoader(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AppLoader).call(this, props));
    _this.state = {
      isLoading: true
    };
    return _this;
  ...
  _createClass(AppLoader, [{
    ...
    value: function componentDidMount() {
      ...
      _core.default.load(name).then(function (appInfo) {
        _this2.setState({
          isLoading: false,
          appInfo: appInfo
        });
      }).catch(function (error) {
        return onError(error, name);
      });
    }
  }, {
    key: "render",
    value: function render() {
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["name", "className", "children"]);
