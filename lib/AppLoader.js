...
var AppLoader = function AppLoader(_ref) {
  var appId = _ref.appId,
      ...
      rest = _objectWithoutProperties(_ref, ["appId", "onError", "renderLoading", "renderError"]);

  var _useState = (0, _react.useState)({}),
      _useState2 = _slicedToArray(_useState, 2),
      appInfo = _useState2[0],
      setAppInfo = _useState2[1];
  ...
  var _useState3 = (0, _react.useState)({
    ...
    isSuccess: false
      ...
      isSuccess = _useState4$.isSuccess,
      setLoadResult = _useState4[1];
  ...
  (0, _react.useEffect)(function () {
    ...
    var app = _context.default.getApp(appId);
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    id: appId
  }, isLoading ? renderLoading() : isSuccess ? /*#__PURE__*/_react.default.createElement(appInfo.tag, rest) : renderError());
};
